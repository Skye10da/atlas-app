...
final _samples = <_SampleBook>[
  const _SampleBook(
    ...
    description:
        'The first Sherlock Holmes novel, introducing the detective and Dr. Watson.',
  ...
  const _SampleBook(
    ...
    author: 'Mark Twain',
    description:
        'The classic tale of childhood adventure along the Mississippi River.',
    chapters: <_SampleChapter>[
      _SampleChapter(
