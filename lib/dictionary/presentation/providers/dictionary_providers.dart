...
final dictionaryRepositoryProvider = Provider<DictionaryRepositoryInterface>((ref) {
  final db = ref.watch(databaseProvider);
  return DriftDictionaryRepository(db);
});

final savedWordsProvider = FutureProvider<List<DictionaryWordEntity>>((ref) async {
